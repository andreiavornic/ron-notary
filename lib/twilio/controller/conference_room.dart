...
class ConferenceRoom with ChangeNotifier {
  ...
  StreamController<Map<String, bool>> _flashStateStreamController;
  ...
  void _onConnected(Room room) {
    ...
    for (final remoteParticipant in room.remoteParticipants) {
      ...
      if (participant == null) {
        print(
            'Adding participant that was already present in the room ${remoteParticipant.identity}, before I connected');
  ...
  void _onDominantSpeakerChanged(DominantSpeakerChangedEvent event) {
    ...
    if (newDominantParticipantIndex != -1) {
  ...
  void _onParticipantConnected(RoomParticipantConnectedEvent event) {
    print(
        'ConferenceRoom._onParticipantConnected, ${event.remoteParticipant.identity}');
  ...
  void _onParticipantDisconnected(RoomParticipantDisconnectedEvent event) {
    print(
        'ConferenceRoom._onParticipantDisconnected: ${event.remoteParticipant.identity}');
  ...
  void _addRemoteParticipantListeners(RemoteParticipant remoteParticipant) {
    print(
        'ConferenceRoom._addRemoteParticipantListeners() => Adding listeners to remoteParticipant ${remoteParticipant.identity}');
    _streamSubscriptions.add(
  ...
  void _onAudioTrackDisabled(RemoteAudioTrackEvent event) {
    print(
        'ConferenceRoom._onAudioTrackDisabled(), ${event.remoteParticipant.identity}, ${event.remoteAudioTrackPublication.trackSid}, isEnabled: ${event.remoteAudioTrackPublication.isTrackEnabled}');
    _setRemoteAudioEnabled(event);
  }

  void _onAudioTrackEnabled(RemoteAudioTrackEvent event) {
    print(
        'ConferenceRoom._onAudioTrackEnabled(), ${event.remoteParticipant.identity}, ${event.remoteAudioTrackPublication.trackSid}, isEnabled: ${event.remoteAudioTrackPublication.isTrackEnabled}');
    _setRemoteAudioEnabled(event);
  }

  void _onAudioTrackPublished(RemoteAudioTrackEvent event) {
    print(
        'ConferenceRoom._onAudioTrackPublished(), ${event.remoteParticipant.identity}}');
  }

  void _onAudioTrackSubscribed(RemoteAudioTrackSubscriptionEvent event) {
    print(
        'ConferenceRoom._onAudioTrackSubscribed(), ${event.remoteParticipant.identity}, ${event.remoteAudioTrackPublication.trackSid}');
  ...
  void _onAudioTrackSubscriptionFailed(
    ...
    print(
        'ConferenceRoom._onAudioTrackSubscriptionFailed(), ${event.remoteParticipant.identity}, ${event.remoteAudioTrackPublication.trackSid}');
  ...
  void _onAudioTrackUnpublished(RemoteAudioTrackEvent event) {
    print(
        'ConferenceRoom._onAudioTrackUnpublished(), ${event.remoteParticipant.identity}, ${event.remoteAudioTrackPublication.trackSid}');
  }

  void _onAudioTrackUnsubscribed(RemoteAudioTrackSubscriptionEvent event) {
    print(
        'ConferenceRoom._onAudioTrackUnsubscribed(), ${event.remoteParticipant.identity}, ${event.remoteAudioTrack.sid}');
  }

  void _onDataTrackPublished(RemoteDataTrackEvent event) {
    print(
        'ConferenceRoom._onDataTrackPublished(), ${event.remoteParticipant.identity}}');
  }

  void _onDataTrackSubscribed(RemoteDataTrackSubscriptionEvent event) {
    print(
        'ConferenceRoom._onDataTrackSubscribed(), ${event.remoteParticipant.identity}, ${event.remoteDataTrackPublication.trackSid}');
  ...
  void _onDataTrackSubscriptionFailed(
    ...
    print(
        'ConferenceRoom._onDataTrackSubscriptionFailed(), ${event.remoteParticipant.identity}, ${event.remoteDataTrackPublication.trackSid}');
    _onExceptionStreamController.add(
      PlatformException(
  ...
  void _onDataTrackUnpublished(RemoteDataTrackEvent event) {
    print(
        'ConferenceRoom._onDataTrackUnpublished(), ${event.remoteParticipant.identity}, ${event.remoteDataTrackPublication.trackSid}');
  }
  ...
  void _onVideoTrackDisabled(RemoteVideoTrackEvent event) {
    print(
        'ConferenceRoom._onVideoTrackDisabled(), ${event.remoteParticipant.identity}, ${event.remoteVideoTrackPublication.trackSid}, isEnabled: ${event.remoteVideoTrackPublication.isTrackEnabled}');
    _setRemoteVideoEnabled(event);
  }

  void _onVideoTrackEnabled(RemoteVideoTrackEvent event) {
    print(
        'ConferenceRoom._onVideoTrackEnabled(), ${event.remoteParticipant.identity}, ${event.remoteVideoTrackPublication.trackSid}, isEnabled: ${event.remoteVideoTrackPublication.isTrackEnabled}');
    _setRemoteVideoEnabled(event);
  }

  void _onVideoTrackPublished(RemoteVideoTrackEvent event) {
    print(
        'ConferenceRoom._onVideoTrackPublished(), ${event.remoteParticipant.identity}, ${event.remoteVideoTrackPublication.trackSid}');
  }

  void _onVideoTrackSubscribed(RemoteVideoTrackSubscriptionEvent event) {
    print(
        'ConferenceRoom._onVideoTrackSubscribed(), ${event.remoteParticipant.identity}, ${event.remoteVideoTrack.sid}');
    _addOrUpdateParticipant(event);
  }
  ...
  void _onVideoTrackSubscriptionFailed(
    ...
    print(
        'ConferenceRoom._onVideoTrackSubscriptionFailed(), ${event.remoteParticipant.identity}, ${event.remoteVideoTrackPublication.trackSid}');
    _onExceptionStreamController.add(
      PlatformException(
  ...
  void _onVideoTrackUnpublished(RemoteVideoTrackEvent event) {
    print(
        'ConferenceRoom._onVideoTrackUnpublished(), ${event.remoteParticipant.identity}, ${event.remoteVideoTrackPublication.trackSid}');
  }

  void _onVideoTrackUnsubscribed(RemoteVideoTrackSubscriptionEvent event) {
    print(
        'ConferenceRoom._onVideoTrackUnsubscribed(), ${event.remoteParticipant.identity}, ${event.remoteVideoTrack.sid}');
  }
  ...
  void _setRemoteAudioEnabled(RemoteAudioTrackEvent event) {
    var index = _participants.indexWhere((ParticipantWidget participant) =>
        participant.id == event.remoteParticipant.identity);
    if (index < 0) {
      return;
    }
  ...
  void _addOrUpdateParticipant(RemoteParticipantEvent event) {
    print(
        'ConferenceRoom._addOrUpdateParticipant(), ${event.remoteParticipant.identity}');
    ...
    if (participant != null) {
      ...
      if (event is RemoteVideoTrackSubscriptionEvent) {
        print('New participant, adding: ${event.remoteParticipant.identity}');
        _participants.insert(
          0,
          _buildParticipant(
